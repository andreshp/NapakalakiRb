...
module Model
    ...
    class ExamenHijo < Examen
        ...
        def run
          ...
          puts p.to_s_xl
          # Monster: Bicéfalo
          badConsequence1 = BadConsequenceSpecificTreasures.new(
          ...
          prize = Prize.new(1,1)
          m1 = Monster.new("Bicéfalo", 20, badConsequence1, prize)

          # Monster (with cultists): El mal indecible impronunciable
          badConsequence2 = BadConsequenceSpecificTreasures.new("Pierdes 1 mano visible.",0,
            [TreasureKind::ONEHAND],[])
          prize = Prize.new(3,1)
          m2 = Monster.new("El mal indecible impronunciable",10,badConsequence2,prize,-2)

          # Monster (with cultists): Testigos oculares
          badConsequence3 = BadConsequenceNumberTreasures.new("Pierdes tus tesoros visibles. Jajaja.",0,100,0)
          prize = Prize.new(2,1)
          m3 = Monster.new("Testigos oculares",6,badConsequence3,prize,6)

          badConsequence4 = BadConsequenceDeath.new("Suspendes PDOO. Estás muerto.")
        ...
        #################################################
          #p.setPendingBadConsequence(badConsequence1.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures))
          #puts p.to_s
          #p.setPendingBadConsequence(badConsequence2.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures))
          #puts p.to_s
          #p.setPendingBadConsequence(badConsequence3.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures))
          #puts p.to_s
          #p.setPendingBadConsequence(badConsequence4.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures))
          #puts p.to_s
          puts badConsequence1.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures)          
          puts badConsequence2.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures)
          puts badConsequence3.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures)
          puts badConsequence4.adjustToFitTreasureLists(p.getVisibleTreasures,p.getHiddenTreasures)          
        #################################################
